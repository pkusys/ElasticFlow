...
parser.add_argument('--data', default='/mnt/data1/imagenet', 
                    help='path to dataset')
parser.add_argument('-a', '--arch', default='inception_v3',
                    choices=model_names,
...
def main_worker(args):
    ...
    if args.autoscale_bsz:
        train_loader.autoscale_batch_size(6400, local_bsz_bounds=(20, 128), gradient_accumulation=True)
...
def train(train_loader, model, criterion, optimizer, epoch, args, writer):
    ...
    for i, (images, target) in enumerate(train_loader):
        ...
        (acc1, correct1, total1), (acc5, correct5, total5) = accuracy(output.logits, target, topk=(1, 5))
