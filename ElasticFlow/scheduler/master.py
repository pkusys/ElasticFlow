            ...
            if updated:
                ...
                for worker_id in self._jobs[job_id].gpu_set:
                    for local_rank in self._jobs[job_id].gpu_set[worker_id]:
                        ...
                        global_ranks.append(utils.get_global_rank(worker_id, local_rank, self._workers[worker_id].num_gpus))
                for worker_id in self._workers:
            ...
            for job_id in self._jobs:
                ...
                for worker_id in self._jobs[job_id].old_gpu_set:
                    for local_rank in self._jobs[job_id].old_gpu_set[worker_id]:
                        src = utils.get_global_rank(worker_id, local_rank, self._workers[worker_id].num_gpus)
                ...
                for worker_id in self._jobs[job_id].gpu_set:
                    if worker_id in self._jobs[job_id].old_gpu_set:
                        break
                    for local_rank in self._jobs[job_id].gpu_set[worker_id]:
                        rank_0 = utils.get_global_rank(worker_id, local_rank, self._workers[worker_id].num_gpus)
                        break 
                    break 
